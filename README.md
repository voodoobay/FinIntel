...
| 现金流分析 | 结构诊断 / 自由现金流 FCF / 现金流质量比率 | 三大活动健康度 + 交叉验证 |
...
一、现金流结构
  ...
  投资活动现金流净额: -6.20 亿
  筹资活动现金流净额: 2.55 亿
  类型诊断: 健康成长型 — 经营造血，投资扩张

二、自由现金流
  FCF: 21.69 亿 (FCF/OCF = 79.26%)
...
- **16 个工具，一个循环**：Agent 自主决定调用哪些工具、以什么顺序调、如何组合结果
